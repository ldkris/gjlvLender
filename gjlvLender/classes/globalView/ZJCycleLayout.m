...
-(void)prepareLayout{
    ...
    for (int i=0; i<_itemCount; i++) {
        ...
        float x = center.x+cosf(2*M_PI/_itemCount*i)*(radius-35);
        float y = center.y+sinf(2*M_PI/_itemCount*i)*(radius-35);
