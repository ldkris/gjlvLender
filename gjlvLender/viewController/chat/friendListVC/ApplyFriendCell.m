...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _addButton.accessibilityIdentifier = @"接受";
        [_addButton setBackgroundColor:[UIColor colorWithRed:10 / 255.0 green:82 / 255.0 blue:104 / 255.0 alpha:1.0]];
        [_addButton setTitle:NSLocalizedString(@"接受", @"接受") forState:UIControlStateNormal];
        ...
        [_refuseButton setTitle:NSLocalizedString(@"拒绝", @"拒绝") forState:UIControlStateNormal];
